"""
Django settings for surveyback project.
...
WSGI_APPLICATION = 'surveyback.wsgi.application'
...
CORS_ALLOWED_ORIGINS = ['https://survey-kiosk-c5934.web.app', 'https://23.22.130.173:443']
